...
import { 
  Calendar, Plus, Trash2, Users, Upload, FileText, Eye, Download, X, Paperclip, ClipboardCheck, Trophy
} from "lucide-react";
            ...
            <Card key={ev.id} className="flex flex-col hover:shadow-md transition-all overflow-hidden rounded-2xl border-border/60">
              ...
              <CardContent className="px-4 pb-4 flex-1 flex flex-col justify-between gap-3">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="w-full h-8 text-xs border-amber-300 text-amber-800 dark:text-amber-300 hover:bg-amber-50"
                  asChild
                >
                  <a href="/admin?tab=event-winners">
                    <Trophy className="h-3.5 w-3.5 mr-1.5 text-amber-500" /> Manage Winners in Awards Tab →
                  </a>
                </Button>
              </CardContent>
            </Card>
