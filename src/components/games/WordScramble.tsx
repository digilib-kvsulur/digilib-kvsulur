...
const WORDS = [
  ...
  // New additions – literature terms
  "FABLE", "GENRE", "SIMILE", "SONNET", "STANZA", "CLIMAX", "DIALOGUE",
  "EPILOGUE", "FOLKLORE", "PROLOGUE", "SATIRE", "SETTING", "SUBPLOT",
  "TRAGEDY", "ALLEGORY", "ANTHOLOGY", "SUSPENSE", "CONFLICT", "IRONY",
  // New additions – science / curriculum
  "ANATOMY", "BIOLOGY", "BOTANY", "CALCIUM", "CIRCUIT", "CLIMATE",
  "DENSITY", "ECOLOGY", "EQUATION", "EROSION", "FRICTION", "GLACIER",
  "GRAVITY", "HABITAT", "HYGIENE", "INERTIA", "MINERAL", "NUCLEUS",
  "OXYGEN", "PHOTON", "POLYGON", "PROTEIN", "QUANTUM", "REFLEX",
  "SPECIES", "TECTONIC", "VELOCITY", "VOLTAGE", "ZOOLOGY",
  // Authors / Books
  "DICKENS", "TOLSTOY", "AUSTEN", "ORWELL", "HEMINGWAY", "NARAYAN",
  "TAGORE", "SHAKESPEARE", "TWAIN", "VERNE",
];
